    ...
    inspector: function(map, opts) {
      ...
      opts = xtend(defaultOpts, opts);
        ...
        map.on(opts.on, function(e) {
            ...
            popupHTML += "<a href='" +
                nominatimLink(feature.properties.name, feature.geometry.coordinates) + "'>OSM Search</a><br>";

            popupHTML += "<table style='table-layout:fixed'>";

            for (property in feature.properties) {
                if (property == opts.highlightProperty) {
            ...
            var popup = new mapboxgl.Popup()
                .setLngLat(centroid(feature).geometry.coordinates)
                .setHTML(popupHTML)
                .addTo(map);
        });
